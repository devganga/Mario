using Mario.Application.Common.Models;
using Mario.Application.TodoItems.Commands.CreateTodoItem;
using Mario.Application.TodoItems.Commands.DeleteTodoItem;
using Mario.Application.TodoItems.Commands.UpdateTodoItem;
using Mario.Application.TodoItems.Commands.UpdateTodoItemDetail;
using Mario.Application.TodoItems.Queries.GetTodoItemsWithPagination;
